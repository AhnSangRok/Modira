...
import com.sparta.springweb.dto.ContentsResponseDto;import com.sparta.springweb.repository.ContentsRepository;
...
public class ContentsService {
    ...
    public Contents getDetailContents(Long id) {
        ...
        int count = likesRepository.countByContentsId(id);
        contents.setLikesCount(count);
        return contents;
    }
